...
const CartSummary: React.FC<CartSummaryProps> = ({ showCheckoutButton = true, onCheckout }) => {
  ...
  return (
    <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 shadow-lg border border-gray-300 dark:border-gray-600">
      <h3 className="text-lg font-semibold text-puffy-dark mb-4">Order Summary</h3>
